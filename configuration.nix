...

{
  ...
  home-manager.users.cam = {
	...
	name = "Launch Terminal";
      ...
      "org/gnome/shell" = {
        favorite-apps = ["brave-browser.desktop" "nvim.desktop" "org.gnome.Console.desktop" "org.gnome.Music.desktop" "org.gnome.Photos.desktop" "org.gnome.Nautilus.desktop"];
